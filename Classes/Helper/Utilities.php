...
// -------------UPDATE TABLE---------------------------------------
    ...
    public static function fetchFromTable($col, $table)
    {
        ...
        // Special handling for encrypted user count
        if ($col === Constants::COUNTUSER && $table === Constants::TABLE_OIDC) {
            return \Miniorange\Oauth\Helper\EncryptionHelper::getUserCount($result);
        }
